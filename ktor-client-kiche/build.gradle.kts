...
mavenPublishing {
    ...
    coordinates(group.toString(), "ktor-client-kiche", version.toString())

    pom {
        name = "Kiche Ktor Client"
        description = "Ktor HttpClient engine speaking HTTP/3 over QUIC, backed by Kiche"
        inceptionYear = "2026"
