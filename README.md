...
dependencies {
    implementation("eu.buney.kiche:kiche:0.1.0-alpha.1")                   // core QUIC + HTTP/3
    // Ktor integrations — all optional:
    implementation("eu.buney.kiche:ktor-client-kiche:0.1.0-alpha.1")       // HTTP/3 client engine (+ WebTransport)
    implementation("eu.buney.kiche:ktor-server-kiche:0.1.0-alpha.1")       // HTTP/3 server engine (+ WebTransport)
    implementation("eu.buney.kiche:ktor-client-h3-adaptive:0.1.0-alpha.1") // Alt-Svc TCP↔QUIC adaptive router
}
```
